...
os.environ["DISCORD_REDIRECT_URI"] = "http://localhost:8001/callback"
...
def test_full_auth_flow() -> None:
    ...
    print("\n[1] Simulating Discord OAuth code exchange...")
    ...
    with patch('requests.post') as mock_post, patch('requests.get') as mock_get:
        ...
        print(f"✓ POST / exchanges code for JWT")
